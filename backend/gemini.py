...
# Accepts either name -- assistant.py's key lookup does the same, so
# whichever one is set in .env (GOOGLE_API_KEY from aistudio.google.com, or
# GEMINI_API_KEY) works for both this module and assistant.py.
